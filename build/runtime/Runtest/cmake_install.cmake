# Install script for directory: /home/ubuntu/klee-2.2/runtime/Runtest
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES "/home/ubuntu/klee-2.2/build/lib/libkleeRuntest.so.1.0")
  if(EXISTS "$ENV{DESTDIR}/usr/local/lib/libkleeRuntest.so.1.0" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/libkleeRuntest.so.1.0")
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES "/home/ubuntu/klee-2.2/build/lib/libkleeRuntest.so")
  if(EXISTS "$ENV{DESTDIR}/usr/local/lib/libkleeRuntest.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/libkleeRuntest.so")
    if(CMAKE_INSTALL_DO_STRIP)
